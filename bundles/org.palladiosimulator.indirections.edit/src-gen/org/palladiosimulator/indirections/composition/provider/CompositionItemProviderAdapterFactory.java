...
public class CompositionItemProviderAdapterFactory extends CompositionAdapterFactory
    ...
    public Adapter createDataChannelToAssemblyContextConnectorAdapter() {
        if (this.dataChannelToAssemblyContextConnectorItemProvider == null) {
            this.dataChannelToAssemblyContextConnectorItemProvider = new DataChannelToAssemblyContextConnectorItemProvider(
                    this);
        }

        return this.dataChannelToAssemblyContextConnectorItemProvider;
    }
    ...
    public Adapter createAssemblyContextToDataChannelConnectorAdapter() {
        if (this.assemblyContextToDataChannelConnectorItemProvider == null) {
            this.assemblyContextToDataChannelConnectorItemProvider = new AssemblyContextToDataChannelConnectorItemProvider(
                    this);
        }

        return this.assemblyContextToDataChannelConnectorItemProvider;
    }
    ...
    public Adapter createDataChannelToDataChannelConnectorAdapter() {
        if (this.dataChannelToDataChannelConnectorItemProvider == null) {
            this.dataChannelToDataChannelConnectorItemProvider = new DataChannelToDataChannelConnectorItemProvider(
                    this);
        }

        return this.dataChannelToDataChannelConnectorItemProvider;
    }
    ...
    public Adapter createAssemblyContextToAssemblyContextConnectorAdapter() {
        if (this.assemblyContextToAssemblyContextConnectorItemProvider == null) {
            this.assemblyContextToAssemblyContextConnectorItemProvider = new AssemblyContextToAssemblyContextConnectorItemProvider(
                    this);
        }

        return this.assemblyContextToAssemblyContextConnectorItemProvider;
    }
    ...
    public void dispose() {
        if (this.dataChannelToAssemblyContextConnectorItemProvider != null) {
            this.dataChannelToAssemblyContextConnectorItemProvider.dispose();
        }
        if (this.assemblyContextToDataChannelConnectorItemProvider != null) {
            this.assemblyContextToDataChannelConnectorItemProvider.dispose();
        }
        if (this.dataChannelToDataChannelConnectorItemProvider != null) {
            this.dataChannelToDataChannelConnectorItemProvider.dispose();
        }
        if (this.assemblyContextToAssemblyContextConnectorItemProvider != null) {
            this.assemblyContextToAssemblyContextConnectorItemProvider.dispose();
        }
    }

    /**
     * A child creation extender for the
     * {@link org.palladiosimulator.pcm.core.composition.CompositionPackage}. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    /**
     * A child creation extender for the {@link SystemPackage}. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
