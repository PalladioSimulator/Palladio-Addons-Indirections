 ...
 * {@link org.palladiosimulator.indirections.composition.DataChannelSinkConnector} object. <!--
...
public class DataChannelSinkConnectorItemProvider extends ConnectorItemProvider {
    ...
    protected void addDataSinkRolePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_DataChannelSinkConnector_dataSinkRole_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_DataChannelSinkConnector_dataSinkRole_feature", "_UI_DataChannelSinkConnector_type"),
    ...
    protected void addAssemblyContextPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_DataChannelSinkConnector_assemblyContext_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_DataChannelSinkConnector_assemblyContext_feature", "_UI_DataChannelSinkConnector_type"),
    ...
    protected void addDataChannelPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_DataChannelSinkConnector_dataChannel_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_DataChannelSinkConnector_dataChannel_feature",
    ...
    /**
     * This returns DataChannelSinkConnector.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/DataChannelSinkConnector"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((DataChannelSinkConnector) object).getEntityName();
