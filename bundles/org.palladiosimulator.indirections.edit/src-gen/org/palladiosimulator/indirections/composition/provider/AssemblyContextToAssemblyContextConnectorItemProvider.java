...
public class AssemblyContextToAssemblyContextConnectorItemProvider extends AssemblyContextSourceConnectorItemProvider {
     ...
     * @generated
     */
    public AssemblyContextToAssemblyContextConnectorItemProvider(final AdapterFactory adapterFactory) {
    ...
    /**
     * This returns AssemblyContextToAssemblyContextConnector.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/AssemblyContextToAssemblyContextConnector"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((AssemblyContextToAssemblyContextConnector) object).getId();
        return label == null || label.length() == 0
                ? this.getString("_UI_AssemblyContextToAssemblyContextConnector_type")
                : this.getString("_UI_AssemblyContextToAssemblyContextConnector_type") + " " + label;
    }
