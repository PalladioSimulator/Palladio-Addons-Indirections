...
public class AssemblyContextToDataChannelConnectorItemProvider extends AssemblyContextSourceConnectorItemProvider {
     ...
     * @generated
     */
    public AssemblyContextToDataChannelConnectorItemProvider(final AdapterFactory adapterFactory) {
    ...
    /**
     * This returns AssemblyContextToDataChannelConnector.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/AssemblyContextToDataChannelConnector"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((AssemblyContextToDataChannelConnector) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_AssemblyContextToDataChannelConnector_type")
                : this.getString("_UI_AssemblyContextToDataChannelConnector_type") + " " + label;
    }
