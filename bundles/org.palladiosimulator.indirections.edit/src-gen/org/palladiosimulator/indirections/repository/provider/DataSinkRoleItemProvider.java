...
public class DataSinkRoleItemProvider extends ProvidedRoleItemProvider {
    ...
    protected void addDataSourceSinkConnectorsPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_DataSinkRole_dataSourceSinkConnectors_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_DataSinkRole_dataSourceSinkConnectors_feature", "_UI_DataSinkRole_type"),
                RepositoryPackage.Literals.DATA_SINK_ROLE__DATA_SOURCE_SINK_CONNECTORS, true, false, true, null, null,
                null));
    }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/DataSinkRole"));
    }
