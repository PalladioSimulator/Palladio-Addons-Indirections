/**
 */
package org.palladiosimulator.indirections.datatypes.provider;
...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.indirections.datatypes.Windowing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Windowing_size_feature",
								"_UI_Windowing_type"),
						DatatypesPackage.Literals.WINDOWING__SIZE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Windowing_shift_feature",
								"_UI_Windowing_type"),
						DatatypesPackage.Literals.WINDOWING__SHIFT, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Windowing_gracePeriod_feature",
								"_UI_Windowing_type"),
						DatatypesPackage.Literals.WINDOWING__GRACE_PERIOD, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
