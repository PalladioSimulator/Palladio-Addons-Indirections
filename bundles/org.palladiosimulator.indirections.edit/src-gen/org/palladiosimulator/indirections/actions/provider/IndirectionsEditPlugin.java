...
/**
 * This is the central singleton for the Indirections edit plugin. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public final class IndirectionsEditPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public static final IndirectionsEditPlugin INSTANCE = new IndirectionsEditPlugin();
