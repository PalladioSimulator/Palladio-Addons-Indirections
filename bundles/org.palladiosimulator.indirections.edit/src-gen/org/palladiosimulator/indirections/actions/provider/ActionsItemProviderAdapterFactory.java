...
public class ActionsItemProviderAdapterFactory extends ActionsAdapterFactory
    ...
    /**
     * This creates an adapter for a
     * {@link org.palladiosimulator.indirections.actions.CreateDataAction}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createCreateDataActionAdapter() {
        if (this.createDataActionItemProvider == null) {
            this.createDataActionItemProvider = new CreateDataActionItemProvider(this);
        }

        return this.createDataActionItemProvider;
    }
    ...
    /**
     * This creates an adapter for a
     * {@link org.palladiosimulator.indirections.actions.PutDataOnStackAction}. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createPutDataOnStackActionAdapter() {
        if (this.putDataOnStackActionItemProvider == null) {
            this.putDataOnStackActionItemProvider = new PutDataOnStackActionItemProvider(this);
        }

        return this.putDataOnStackActionItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (this.createDataActionItemProvider != null) {
            this.createDataActionItemProvider.dispose();
        }
        if (this.putDataOnStackActionItemProvider != null) {
            this.putDataOnStackActionItemProvider.dispose();
        }
    }
        ...
        protected static class CreationSwitch extends SeffSwitch<Object> {
            ...
            public Object caseResourceDemandingBehaviour(final ResourceDemandingBehaviour object) {
                this.newChildDescriptors.add(
                        this.createChildParameter(SeffPackage.Literals.RESOURCE_DEMANDING_BEHAVIOUR__STEPS_BEHAVIOUR,
