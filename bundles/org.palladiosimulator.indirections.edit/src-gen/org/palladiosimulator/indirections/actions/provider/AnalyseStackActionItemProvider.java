...
public class AnalyseStackActionItemProvider extends AbstractActionItemProvider {
    ...
    protected void addKeyPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_AnalyseStackAction_key_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_AnalyseStackAction_key_feature",
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ActionsPackage.Literals.ANALYSE_STACK_ACTION__VARIABLE_REFERENCE);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/AnalyseStackAction"));
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors
                .add(this.createChildParameter(ActionsPackage.Literals.ANALYSE_STACK_ACTION__VARIABLE_REFERENCE,
