...
public class ConsumeDataActionItemProvider extends AbstractActionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addEventTypePropertyDescriptor(object);
    ...
    /**
     * This adds a property descriptor for the Event Type feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    protected void addEventTypePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ConsumeDataAction_eventType_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ConsumeDataAction_eventType_feature",
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ActionsPackage.Literals.CONSUME_DATA_ACTION__VARIABLE_REFERENCE);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ConsumeDataAction"));
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors
                .add(this.createChildParameter(ActionsPackage.Literals.CONSUME_DATA_ACTION__VARIABLE_REFERENCE,
