...
public class DataChannelItemProvider extends EventChannelItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOutgoingDistributionPropertyDescriptor(object);
			addSchedulingPropertyDescriptor(object);
			addPutPolicyPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Outgoing Distribution feature.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOutgoingDistributionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DataChannel_outgoingDistribution_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DataChannel_outgoingDistribution_feature",
								"_UI_DataChannel_type"),
	...
	/**
	 * This adds a property descriptor for the Put Policy feature.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	protected void addPutPolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DataChannel_putPolicy_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DataChannel_putPolicy_feature",
								"_UI_DataChannel_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemPackage.Literals.DATA_CHANNEL__JOINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SystemPackage.Literals.DATA_CHANNEL__JOINS,
