 ...
 * {@link org.palladiosimulator.indirections.system.IndirectionsAwareSystem} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class IndirectionsAwareSystemItemProvider extends SystemItemProvider {
    /**
     ...
     * @generated
     */
    public IndirectionsAwareSystemItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(SystemPackage.Literals.INDIRECTIONS_AWARE_SYSTEM__DATA_CHANNELS);
        }
    ...
    /**
     * This returns IndirectionsAwareSystem.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/IndirectionsAwareSystem"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((IndirectionsAwareSystem) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_IndirectionsAwareSystem_type")
                : this.getString("_UI_IndirectionsAwareSystem_type") + " " + label;
    }
    ...
    public void notifyChanged(final Notification notification) {
        ...
        switch (notification.getFeatureID(IndirectionsAwareSystem.class)) {
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors
            .add(this.createChildParameter(SystemPackage.Literals.INDIRECTIONS_AWARE_SYSTEM__DATA_CHANNELS,
                    SystemFactory.eINSTANCE.createJavaClassDataChannel()));
    }
