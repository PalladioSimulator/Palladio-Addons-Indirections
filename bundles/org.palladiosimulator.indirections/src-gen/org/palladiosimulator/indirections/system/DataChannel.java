 ...
 *
 * <!-- begin-model-doc -->
 * <p>Note that this class is also a {@link ResourceInterfaceRequiringEntity}</p> <p>TODO: validation for derived attribute should be implemented (type must be DataSinkRole/DataSourceRole)</p>
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.indirections.system.DataChannel#getDataSinkRoles <em>Data Sink Roles</em>}</li>
 *   <li>{@link org.palladiosimulator.indirections.system.DataChannel#getDataSourceRoles <em>Data Source Roles</em>}</li>
 * </ul>
 *
...
public interface DataChannel extends InterfaceProvidingRequiringEntity {
	/**
	 * Returns the value of the '<em><b>Data Sink Roles</b></em>' reference list.
	...
	/**
	 * Returns the value of the '<em><b>Data Source Roles</b></em>' reference list.
