...
public class SystemFactoryImpl extends EFactoryImpl implements SystemFactory {
    ...
    public EObject create(final EClass eClass) {
        ...
        case SystemPackage.INDIRECTIONS_AWARE_SYSTEM:
            return this.createIndirectionsAwareSystem();
        default:
     ...
     */
    @Override
    public IndirectionsAwareSystem createIndirectionsAwareSystem() {
        final IndirectionsAwareSystemImpl indirectionsAwareSystem = new IndirectionsAwareSystemImpl();
        return indirectionsAwareSystem;
    }
