...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Assembly Context Sink Connector</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * Connector that has an AssemblyContext as its sink.<p>TODO: should check whether the given sink role fits to the pushing service
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#getSinkAssemblyContext <em>Sink Assembly Context</em>}</li>
 *   <li>{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#getPushesTo <em>Pushes To</em>}</li>
 *   <li>{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#isPushing <em>Pushing</em>}</li>
 * </ul>
 *
...
public interface AssemblyContextSinkConnector extends DataSourceSinkConnector {
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#getSinkAssemblyContext <em>Sink Assembly Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Sink Assembly Context</em>' reference.
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * If this is empty, then the connector does not push. If it is set, the connection is pushing.
	 * <!-- end-model-doc -->
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#getPushesTo <em>Pushes To</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.indirections.composition.abstract_.AssemblyContextSinkConnector#isPushing <em>Pushing</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Pushing</em>' attribute.
	 * @see #isPushing()
	 * @generated
	 */
