...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Data Channel Sink
 * Connector</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Connector that has a DataChannel as its sink. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.indirections.composition.abstract_.DataChannelSinkConnector#getSinkDataChannel
...
public interface DataChannelSinkConnector extends DataSourceSinkConnector {
    /**
     * Returns the value of the '<em><b>Sink Data Channel</b></em>' reference. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     ...
     * <em>Sink Data Channel</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Sink Data Channel</em>' reference.
