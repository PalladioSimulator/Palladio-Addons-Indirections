...
public class AllocationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AllocationSwitch<Adapter> modelSwitch = new AllocationSwitch<Adapter>() {
        @Override
        public Adapter caseIndirectionsAwareAllocation(final IndirectionsAwareAllocation object) {
            return AllocationAdapterFactory.this.createIndirectionsAwareAllocationAdapter();
        }

        @Override
        public Adapter caseDataChannelAllocationContext(final DataChannelAllocationContext object) {
            return AllocationAdapterFactory.this.createDataChannelAllocationContextAdapter();
        }
     ...
     * <em>Indirections Aware Allocation</em>}'. <!-- begin-user-doc --> This default implementation
     ...
     * @generated
     */
    public Adapter createIndirectionsAwareAllocationAdapter() {
        return null;
    }
     ...
     * Channel Allocation Context</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createDataChannelAllocationContextAdapter() {
        return null;
    }
