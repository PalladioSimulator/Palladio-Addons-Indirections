...
public class PartitioningPackageImpl extends EPackageImpl implements PartitioningPackage {
	...
	public EAttribute getCollectWithHoldback_PartitionDataName() {
		return (EAttribute) collectWithHoldbackEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(collectWithHoldbackEClass, COLLECT_WITH_HOLDBACK__PARTITION_DATA_NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCollectWithHoldback_Key(), ecorePackage.getEString(), "key", null, 1, 1,
				CollectWithHoldback.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCollectWithHoldback_PartitionDataName(), ecorePackage.getEString(), "partitionDataName", null,
				0, 1, CollectWithHoldback.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
