 ...
 * @generated
 */
public class IndirectionsSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        switch (classifierID) {
        case IndirectionsPackage.JAVA_CLASS_REALIZATION: {
            final JavaClassRealization javaClassRealization = (JavaClassRealization) theEObject;
            T result = this.caseJavaClassRealization(javaClassRealization);
            if (result == null) {
