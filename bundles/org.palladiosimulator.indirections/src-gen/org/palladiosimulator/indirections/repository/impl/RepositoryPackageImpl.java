...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
    ...
    public EReference getDataSinkRole_EventGroup() {
        return (EReference) this.dataSinkRoleEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public EReference getDataSourceRole_EventGroup() {
        return (EReference) this.dataSourceRoleEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public void createPackageContents() {
        ...
        this.createEReference(this.dataSinkRoleEClass, DATA_SINK_ROLE__DATA_SOURCE_SINK_CONNECTORS);
        ...
        this.createEReference(this.dataSourceRoleEClass, DATA_SOURCE_ROLE__DATA_SOURCE_SINK_CONNECTORS);
    }
    ...
    public void initializePackageContents() {
        ...
        this.dataSinkRoleEClass.getESuperTypes()
            .add(theRepositoryPackage_1.getProvidedRole());
        this.dataSourceRoleEClass.getESuperTypes()
            .add(theRepositoryPackage_1.getRequiredRole());
        ...
        this.initEReference(this.getDataSinkRole_DataSourceSinkConnectors(),
                theAbstractPackage.getDataSourceSinkConnector(),
        ...
        this.initEReference(this.getDataSourceRole_DataSourceSinkConnectors(),
                theAbstractPackage.getDataSourceSinkConnector(),
