...
public class ActionsPackageImpl extends EPackageImpl implements ActionsPackage {
	...
	public EReference getAnalyseStackAction_VariableReference() {
		return (EReference) analyseStackActionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getAnalyseStackAction_MeasurementIdentificationKey() {
		return (EAttribute) analyseStackActionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getCreateDateAction_VariableReference() {
		return (EReference) createDateActionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getCreateDateAction_VariableUsages() {
		return (EReference) createDateActionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getAddToDateAction_VariableReference() {
		return (EReference) addToDateActionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getAddToDateAction_VariableUsages() {
		return (EReference) addToDateActionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getDataIteratorAction_VariableReference() {
		return (EReference) dataIteratorActionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(analyseStackActionEClass, ANALYSE_STACK_ACTION__MEASUREMENT_IDENTIFICATION_KEY);
		...
		createDateActionEClass = createEClass(CREATE_DATE_ACTION);
		createEReference(createDateActionEClass, CREATE_DATE_ACTION__VARIABLE_REFERENCE);
		createEReference(createDateActionEClass, CREATE_DATE_ACTION__VARIABLE_USAGES);

		addToDateActionEClass = createEClass(ADD_TO_DATE_ACTION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAnalyseStackAction_MeasurementIdentificationKey(), ecorePackage.getEString(),
		...
		initEClass(createDateActionEClass, CreateDateAction.class, "CreateDateAction", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCreateDateAction_VariableReference(), theStoexPackage.getVariableReference(), null,
				"variableReference", null, 1, 1, CreateDateAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCreateDateAction_VariableUsages(), theParameterPackage.getVariableUsage(), null,
				"variableUsages", null, 0, -1, CreateDateAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(addToDateActionEClass, AddToDateAction.class, "AddToDateAction", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAddToDateAction_VariableReference(), theStoexPackage.getVariableReference(), null,
