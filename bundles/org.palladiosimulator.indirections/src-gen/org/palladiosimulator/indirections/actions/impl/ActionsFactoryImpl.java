...
public class ActionsFactoryImpl extends EFactoryImpl implements ActionsFactory {
    ...
    public EObject create(final EClass eClass) {
        ...
        case ActionsPackage.JAVA_CLASS_REGROUP_DATA_ACTION:
            return this.createJavaClassRegroupDataAction();
        default:
    ...
    public JavaClassRegroupDataAction createJavaClassRegroupDataAction() {
        final JavaClassRegroupDataActionImpl javaClassRegroupDataAction = new JavaClassRegroupDataActionImpl();
        return javaClassRegroupDataAction;
    }
