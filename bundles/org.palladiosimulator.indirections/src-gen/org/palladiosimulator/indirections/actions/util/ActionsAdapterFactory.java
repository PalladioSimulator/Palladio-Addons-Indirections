...
public class ActionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActionsSwitch<Adapter> modelSwitch = new ActionsSwitch<Adapter>() {
		...
		@Override
		public Adapter caseCreateDateAction(CreateDateAction object) {
			return createCreateDateActionAdapter();
		}

		@Override
		public Adapter caseAddToDateAction(AddToDateAction object) {
			return createAddToDateActionAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.indirections.actions.CreateDateAction <em>Create Date Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.indirections.actions.AddToDateAction <em>Add To Date Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.indirections.actions.DataIteratorAction <em>Data Iterator Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
