...
public interface ActionsFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Create Date Action</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Add To Date Action</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Data Iterator Action</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Put Time On Stack Action</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Java Class Regroup Data Action</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @return a new object of class '<em>Java Class Regroup Data Action</em>'.
     * @generated
     */
