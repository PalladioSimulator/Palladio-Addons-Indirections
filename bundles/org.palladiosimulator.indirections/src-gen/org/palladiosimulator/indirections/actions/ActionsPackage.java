...
public interface ActionsPackage extends EPackage {
     ...
     * '{@link org.palladiosimulator.indirections.actions.impl.DataActionImpl <em>Data Action</em>}'
     * class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see org.palladiosimulator.indirections.actions.impl.DataActionImpl
     ...
     * @ordered
     */
    int DATA_ACTION__ID = SeffPackage.ABSTRACT_ACTION__ID;
     ...
     * @ordered
     */
    int DATA_ACTION__ENTITY_NAME = SeffPackage.ABSTRACT_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION = SeffPackage.ABSTRACT_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION = SeffPackage.ABSTRACT_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = SeffPackage.ABSTRACT_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int DATA_ACTION__VARIABLE_REFERENCE = SeffPackage.ABSTRACT_ACTION_FEATURE_COUNT + 0;

    /**
     * The number of structural features of the '<em>Data Action</em>' class. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int DATA_ACTION_FEATURE_COUNT = SeffPackage.ABSTRACT_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION__MEASUREMENT_IDENTIFICATION_KEY = DATA_ACTION_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int ANALYSE_STACK_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION__DATA_SINK_ROLE = DATA_ACTION_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int CONSUME_DATA_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION__DATA_SOURCE_ROLE = DATA_ACTION_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int EMIT_DATA_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION__VARIABLE_USAGES = DATA_ACTION_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int CREATE_DATE_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION__VARIABLE_USAGES = DATA_ACTION_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int ADD_TO_DATE_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;
     ...
     * @ordered
     */
    int PUT_TIME_ON_STACK_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 0;

    /**
     * The meta object id for the
     * '{@link org.palladiosimulator.indirections.actions.impl.RegroupDataActionImpl <em>Regroup
     * Data Action</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see org.palladiosimulator.indirections.actions.impl.RegroupDataActionImpl
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__ID = DATA_ACTION__ID;
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__ENTITY_NAME = DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION = DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION = DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int REGROUP_DATA_ACTION__VARIABLE_REFERENCE = DATA_ACTION__VARIABLE_REFERENCE;

    /**
     * The number of structural features of the '<em>Regroup Data Action</em>' class. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int REGROUP_DATA_ACTION_FEATURE_COUNT = DATA_ACTION_FEATURE_COUNT + 0;

    /**
     * The meta object id for the
     * '{@link org.palladiosimulator.indirections.actions.impl.JavaClassRegroupDataActionImpl
     * <em>Java Class Regroup Data Action</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @see org.palladiosimulator.indirections.actions.impl.JavaClassRegroupDataActionImpl
     ...
     * @ordered
     */
    int JAVA_CLASS_REGROUP_DATA_ACTION__ID = REGROUP_DATA_ACTION__ID;
     ...
     * @ordered
     */
    int JAVA_CLASS_REGROUP_DATA_ACTION__ENTITY_NAME = REGROUP_DATA_ACTION__ENTITY_NAME;
     ...
     * @ordered
     */
    int JAVA_CLASS_REGROUP_DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION = REGROUP_DATA_ACTION__PREDECESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int JAVA_CLASS_REGROUP_DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION = REGROUP_DATA_ACTION__SUCCESSOR_ABSTRACT_ACTION;
     ...
     * @ordered
     */
    int JAVA_CLASS_REGROUP_DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION = REGROUP_DATA_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
     ...
     * Action</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Regroup Data Action</em>'.
     ...
     * Regroup Data Action</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Java Class Regroup Data Action</em>'.
     ...
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Data Action</em>'.
     ...
     * '{@link org.palladiosimulator.indirections.actions.DataAction#getVariableReference
     ...
     * @see org.palladiosimulator.indirections.actions.DataAction#getVariableReference()
     * @see #getDataAction()
     * @generated
     */
    ...
    interface Literals {
         ...
         * @generated
         */
        EClass REGROUP_DATA_ACTION = eINSTANCE.getRegroupDataAction();

        /**
         * The meta object literal for the
         * '{@link org.palladiosimulator.indirections.actions.impl.JavaClassRegroupDataActionImpl
         * <em>Java Class Regroup Data Action</em>}' class. <!-- begin-user-doc --> <!--
         * end-user-doc -->
         *
         * @see org.palladiosimulator.indirections.actions.impl.JavaClassRegroupDataActionImpl
         * @see org.palladiosimulator.indirections.actions.impl.ActionsPackageImpl#getJavaClassRegroupDataAction()
         * @generated
         */
        EClass JAVA_CLASS_REGROUP_DATA_ACTION = eINSTANCE.getJavaClassRegroupDataAction();

        /**
         * The meta object literal for the
         * '{@link org.palladiosimulator.indirections.actions.impl.DataActionImpl <em>Data
         * Action</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         *
         * @see org.palladiosimulator.indirections.actions.impl.DataActionImpl
         * @see org.palladiosimulator.indirections.actions.impl.ActionsPackageImpl#getDataAction()
         ...
         * @generated
         */
        EReference DATA_ACTION__VARIABLE_REFERENCE = eINSTANCE.getDataAction_VariableReference();
