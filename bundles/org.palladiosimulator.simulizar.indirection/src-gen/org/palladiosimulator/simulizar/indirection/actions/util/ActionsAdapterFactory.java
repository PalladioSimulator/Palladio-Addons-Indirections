/**
 */
package org.palladiosimulator.simulizar.indirection.actions.util;
...
public class ActionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActionsSwitch<Adapter> modelSwitch = new ActionsSwitch<Adapter>() {
		...
		@Override
		public Adapter caseConsumeEventAction(ConsumeEventAction object) {
			return createConsumeEventActionAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.simulizar.indirection.actions.AnalyseStackAction <em>Analyse Stack Action</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.simulizar.indirection.actions.ConsumeEventAction <em>Consume Event Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConsumeEventActionAdapter() {
		return null;
	}
