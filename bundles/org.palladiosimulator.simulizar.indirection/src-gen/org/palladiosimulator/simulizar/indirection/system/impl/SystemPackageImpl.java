...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 * @see org.palladiosimulator.simulizar.indirection.system.SystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getDataChannel_Partitioning() {
		return (EReference) dataChannelEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getDataChannel_TimeGrouping() {
		return (EReference) dataChannelEClass.getEStructuralFeatures().get(6);
	}
