...
public class DiscardingDataChannelResource extends AbstractSimDataChannelResource {
    public DiscardingDataChannelResource(final DataChannel dataChannel, final InterpreterDefaultContext context,
