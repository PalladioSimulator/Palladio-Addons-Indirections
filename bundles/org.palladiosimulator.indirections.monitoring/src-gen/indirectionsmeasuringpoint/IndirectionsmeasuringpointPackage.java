/**
 */
package indirectionsmeasuringpoint;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see indirectionsmeasuringpoint.IndirectionsmeasuringpointFactory
 * @model kind="package"
 * @generated
 */
public interface IndirectionsmeasuringpointPackage extends EPackage {
     ...
     * @generated
     */
    IndirectionsmeasuringpointPackage eINSTANCE = indirectionsmeasuringpoint.impl.IndirectionsmeasuringpointPackageImpl.init();

    /**
     * The meta object id for the '{@link indirectionsmeasuringpoint.impl.AbstractActionDataMeasuringPointImpl <em>Abstract Action Data Measuring Point</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see indirectionsmeasuringpoint.impl.AbstractActionDataMeasuringPointImpl
     * @see indirectionsmeasuringpoint.impl.IndirectionsmeasuringpointPackageImpl#getAbstractActionDataMeasuringPoint()
     * @generated
     */
    ...
    /**
     * Returns the meta object for class '{@link indirectionsmeasuringpoint.AbstractActionDataMeasuringPoint <em>Abstract Action Data Measuring Point</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Abstract Action Data Measuring Point</em>'.
     * @see indirectionsmeasuringpoint.AbstractActionDataMeasuringPoint
     * @generated
     */
    EClass getAbstractActionDataMeasuringPoint();

    /**
     * Returns the meta object for the reference '{@link indirectionsmeasuringpoint.AbstractActionDataMeasuringPoint#getAbstractAction <em>Abstract Action</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference '<em>Abstract Action</em>'.
     * @see indirectionsmeasuringpoint.AbstractActionDataMeasuringPoint#getAbstractAction()
    ...
    interface Literals {
        /**
         * The meta object literal for the '{@link indirectionsmeasuringpoint.impl.AbstractActionDataMeasuringPointImpl <em>Abstract Action Data Measuring Point</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see indirectionsmeasuringpoint.impl.AbstractActionDataMeasuringPointImpl
         * @see indirectionsmeasuringpoint.impl.IndirectionsmeasuringpointPackageImpl#getAbstractActionDataMeasuringPoint()
