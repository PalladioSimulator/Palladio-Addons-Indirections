...
public class IndirectionsmeasuringpointAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected IndirectionsmeasuringpointSwitch<Adapter> modelSwitch =
        new IndirectionsmeasuringpointSwitch<Adapter>() {
            @Override
            public Adapter caseAbstractActionDataMeasuringPoint(AbstractActionDataMeasuringPoint object) {
                return createAbstractActionDataMeasuringPointAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link indirectionsmeasuringpoint.AbstractActionDataMeasuringPoint <em>Abstract Action Data Measuring Point</em>}'.
     * <!-- begin-user-doc -->
