...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.simulizar.indirection.composition.DataChannelSinkConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addSinkRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DataChannelSinkConnector_sinkRole_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DataChannelSinkConnector_sinkRole_feature",
								"_UI_DataChannelSinkConnector_type"),
						CompositionPackage.Literals.DATA_CHANNEL_SINK_CONNECTOR__SINK_ROLE, true, false, true, null,
						null, null));
	}
